...
class TestFilesystem(ContentlibraryLayerTest):
    ...
    def test_from_filesystem(self):
        ...
        assert_that(ext_package, has_entry('PlatformPresentationResources',
                                           contains_inanyorder(
                                               has_entry(
                                                   'href',
                                                   '/TestFilesystem/presentation-assets/iPad/v1/'),
                                               has_entry(
                                                   'href',
    ...
    def test_library(self):
        ...
        assert_that(embed_paths[0][-1],
                    has_property('ntiid',
                                 'tag:nextthought.com,2011-10:USSC-HTML-Cohen.28'))
    ...
    def test_site_library(self):
        global_library = filesystem.GlobalFilesystemContentPackageLibrary(
